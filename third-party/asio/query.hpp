...
namespace asio_query_fn {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               static_query<T, Property>::is_valid>> : static_query<T, Property> {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               query_member<typename Impl::template proxy<T>::type, Property>::is_valid>> : query_member<typename Impl::template proxy<T>::type, Property> {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               query_free<T, Property>::is_valid>> : query_free<T, Property> {
