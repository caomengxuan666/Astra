...
namespace asio {
    ...
    namespace detail {
        ...
        struct associated_immediate_executor_impl<T, E,
                                                  ...
                                                  void_t<
                                                          typename associator<associated_immediate_executor, T, E>::type>> : associator<associated_immediate_executor, T, E> {
        };
 ...
 */
    ...
    ASIO_NODISCARD inline auto get_associated_immediate_executor(
            ...
            constraint_t<
                    is_executor<Executor>::value || execution::is_executor<Executor>::value> = 0) noexcept
 ...
 */
    ...
    get_associated_immediate_executor(const T &t, ExecutionContext &ctx,
                                      constraint_t<
                                              is_convertible<ExecutionContext &, execution_context &>::value> = 0) noexcept {
