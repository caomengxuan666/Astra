 ...
 */
    ...
    public:
        ...
        ASIO_NODISCARD inline constexpr cancel_at_t<decay_t<CompletionToken>, Clock, WaitTraits>
 ...
 */
    ...
    public:
        ...
        /// arguments should be combined into a single tuple argument.
        template<typename CompletionToken>
        ASIO_NODISCARD inline cancel_at_timer<decay_t<CompletionToken>, Clock, WaitTraits, Executor>
        operator()(CompletionToken &&completion_token) const {
