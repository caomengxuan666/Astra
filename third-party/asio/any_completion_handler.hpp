    ...
    namespace detail {
        ...
        public:
            ...
            void *allocate(std::size_t size, std::size_t align) const {
                typename std::allocator_traits<
                        associated_allocator_t<Handler,
                                               asio::recycling_allocator<void>>>::template rebind_alloc<unsigned char>
                        alloc(
                                (get_associated_allocator) (handler_,
                                                            asio::recycling_allocator<void>()));
 ...
 */
    ...
    public:
        ...
        any_completion_handler(H &&h,
                               constraint_t<
                                       !is_same<decay_t<H>, any_completion_handler>::value> = 0)
            : fn_table_(
   ...
   */
        any_completion_handler &operator=(
            ...
            any_completion_handler(
                    static_cast<any_completion_handler &&>(other))
                    .swap(*this);
            return *this;
        }
