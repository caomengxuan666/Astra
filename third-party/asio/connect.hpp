 ...
 */
    ...
    typename Protocol::endpoint connect(basic_socket<Protocol, Executor> &s,
                                        ...
                                        constraint_t<
                                                is_endpoint_sequence<EndpointSequence>::value> = 0);
 ...
 */
    ...
    Iterator connect(basic_socket<Protocol, Executor> &s, Iterator begin,
                     constraint_t<
                             !is_endpoint_sequence<Iterator>::value> = 0);
    ...
    typename Protocol::endpoint connect(basic_socket<Protocol, Executor> &s,
                                        ...
                                        constraint_t<
                                                is_connect_condition<ConnectCondition,
                                                                     decltype(declval<const EndpointSequence &>().begin())>::value> = 0);
 ...
 */
    ...
    Iterator connect(basic_socket<Protocol, Executor> &s,
                     ...
                     constraint_t<
                             !is_endpoint_sequence<Iterator>::value> = 0,
                     constraint_t<
                             is_connect_condition<ConnectCondition, Iterator>::value> = 0);
 ...
 */
    ...
    inline auto async_connect(basic_socket<Protocol, Executor> &s, Iterator begin,
                              ...
                              constraint_t<
                                      !is_endpoint_sequence<Iterator>::value> = 0,
                              constraint_t<
                                      !is_same<Iterator, decay_t<IteratorConnectToken>>::value> = 0,
                              constraint_t<
                                      !is_connect_condition<IteratorConnectToken, Iterator>::value> = 0)
