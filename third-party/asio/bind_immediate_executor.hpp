 ...
 */
    ...
    struct partial_immediate_executor_binder {
        ...
        ASIO_NODISCARD inline constexpr immediate_executor_binder<decay_t<CompletionToken>, Executor>
    ...
    class async_result<immediate_executor_binder<T, Executor>, Signature> : public detail::immediate_executor_binder_completion_handler_async_result<
