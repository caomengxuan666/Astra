...
namespace asio {
    namespace detail {
        ...
        struct composed_work_guard<Executor,
                                   enable_if_t<
                                           !execution::is_executor<Executor>::value>> : executor_work_guard<Executor> {
            composed_work_guard(const Executor &ex)
        ...
        get_composed_io_executor(IoObject &io_object,
                                 enable_if_t<
                                         !is_executor<IoObject>::value> * = 0,
                                 enable_if_t<
                                         !execution::is_executor<IoObject>::value> * = 0) {
        ...
        inline const Executor &get_composed_io_executor(const Executor &ex,
                                                        enable_if_t<
                                                                is_executor<Executor>::value || execution::is_executor<Executor>::value> * = 0) {
            return ex;
        }
