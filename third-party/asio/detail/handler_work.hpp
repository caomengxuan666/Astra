...
namespace asio {
    ...
    namespace detail {
        ...
        class handler_work_base<Executor, CandidateExecutor,
                                ...
                                enable_if_t<
                                        !execution::is_executor<Executor>::value && (!is_same<Executor, PolymorphicExecutor>::value || !is_same<CandidateExecutor, void>::value)>> {
        public:
            explicit handler_work_base(int, int, const Executor &ex) noexcept
                : executor_(ex),
                  owns_work_(true) {
        ...
        class handler_work_base<Executor, void, IoContext, PolymorphicExecutor,
                                enable_if_t<
                                        is_same<
                                                Executor,
                                                typename IoContext::executor_type>::value>> {
        public:
        ...
        class handler_work_base<
                ...
                IoContext, PolymorphicExecutor,
                enable_if_t<
                        is_same<Executor, any_completion_executor>::value || is_same<Executor, any_io_executor>::value>> {
        public:
