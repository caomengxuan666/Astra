 ...
 */
    ...
    public:
        ...
        ASIO_NODISCARD inline cancel_after_t<decay_t<CompletionToken>, Clock, WaitTraits>
 ...
 */
    ...
    public:
        ...
        /// arguments should be combined into a single tuple argument.
        template<typename CompletionToken>
        ASIO_NODISCARD inline cancel_after_timer<decay_t<CompletionToken>, Clock, WaitTraits, Executor>
        operator()(CompletionToken &&completion_token) const {
 ...
 */
    ...
    ASIO_NODISCARD inline partial_cancel_after_timer<Clock, WaitTraits, Executor>
 ...
 */
    ...
    ASIO_NODISCARD inline cancel_after_t<decay_t<CompletionToken>, chrono::steady_clock>
    cancel_after(const chrono::duration<Rep, Period> &timeout,
 ...
 */
    template<typename Clock, typename WaitTraits, typename Executor,
             typename Rep, typename Period, typename CompletionToken>
    ASIO_NODISCARD inline cancel_after_timer<decay_t<CompletionToken>, chrono::steady_clock>
    cancel_after(basic_waitable_timer<Clock, WaitTraits, Executor> &timer,
                 const chrono::duration<Rep, Period> &timeout,
                 cancellation_type_t cancel_type, CompletionToken &&completion_token) {
        return cancel_after_timer<decay_t<CompletionToken>,
