 ...
 */
    ...
    std::size_t read(SyncReadStream &s, const MutableBufferSequence &buffers,
                     constraint_t<
                             is_mutable_buffer_sequence<MutableBufferSequence>::value> = 0);
 ...
 */
    ...
    std::size_t read(SyncReadStream &s, const MutableBufferSequence &buffers,
                     ...
                     constraint_t<
                             is_mutable_buffer_sequence<MutableBufferSequence>::value> = 0,
                     constraint_t<
                             is_completion_condition<CompletionCondition>::value> = 0);
 ...
 */
    ...
    std::size_t read(SyncReadStream &s,
                     ...
                     constraint_t<
                             is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value> = 0,
                     constraint_t<
                             !is_dynamic_buffer_v2<decay_t<DynamicBuffer_v1>>::value> = 0);
 ...
 */
    ...
    std::size_t read(SyncReadStream &s, DynamicBuffer_v2 buffers,
                     constraint_t<
                             is_dynamic_buffer_v2<DynamicBuffer_v2>::value> = 0);
 ...
 */
    template<typename AsyncReadStream, typename MutableBufferSequence,
             ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code,
                                            std::size_t)) ReadToken = default_completion_token_t<typename AsyncReadStream::executor_type>>
    inline auto async_read(AsyncReadStream &s, const MutableBufferSequence &buffers,
                           ...
                           constraint_t<
                                   is_mutable_buffer_sequence<MutableBufferSequence>::value> = 0,
                           constraint_t<
                                   !is_completion_condition<ReadToken>::value> = 0)
