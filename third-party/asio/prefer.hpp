...
namespace asio_prefer_fn {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               !static_require<T, Property>::is_valid>,
                       enable_if_t<
                               require_member<typename Impl::template proxy<T>::type, Property>::is_valid>> : require_member<typename Impl::template proxy<T>::type, Property> {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               require_free<T, Property>::is_valid>> : require_free<T, Property> {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               prefer_member<typename Impl::template proxy<T>::type, Property>::is_valid>> : prefer_member<typename Impl::template proxy<T>::type, Property> {
    ...
    struct call_traits<Impl, T, void(Property),
                       ...
                       enable_if_t<
                               prefer_free<T, Property>::is_valid>> : prefer_free<T, Property> {
