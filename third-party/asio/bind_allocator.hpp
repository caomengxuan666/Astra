 ...
 */
    ...
    struct partial_allocator_binder {
        ...
        ASIO_NODISCARD inline constexpr allocator_binder<decay_t<CompletionToken>, Allocator>
    ...
    class async_result<allocator_binder<T, Allocator>, Signature> : public detail::allocator_binder_completion_handler_async_result<
