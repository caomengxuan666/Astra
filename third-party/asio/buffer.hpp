 ...
 */
    ...
    inline const mutable_buffer *buffer_sequence_begin(const MutableBuffer &b,
                                                       constraint_t<
                                                               is_convertible<const MutableBuffer *, const mutable_buffer *>::value> = 0) noexcept {
    ...
    inline const const_buffer *buffer_sequence_begin(const ConstBuffer &b,
                                                     constraint_t<
                                                             is_convertible<const ConstBuffer *, const const_buffer *>::value> = 0) noexcept {
    ...
    inline auto buffer_sequence_begin(C &c,
                                      constraint_t<
                                              !is_convertible<const C *, const mutable_buffer *>::value && !is_convertible<const C *, const const_buffer *>::value> = 0) noexcept -> decltype(c.begin()) {
        return c.begin();
    }
 ...
 */
    ...
    inline auto buffer_sequence_end(C &c,
                                    constraint_t<
                                            !is_convertible<const C *, const mutable_buffer *>::value && !is_convertible<const C *, const const_buffer *>::value> = 0) noexcept -> decltype(c.end()) {
        return c.end();
    }
    ...
    namespace detail {
        ...
        struct buffer_sequence_cardinality : conditional_t<
 ...
 */
    ...
    ASIO_NODISCARD inline ASIO_MUTABLE_BUFFER buffer(
            ...
            constraint_t<
                    !is_const<
                            remove_reference_t<
                                    typename std::iterator_traits<typename T::iterator>::reference>>::value,
    ...
    namespace buffer_literals {
        namespace detail {
            ...
            struct bin_literal<bytes<Bytes...>, Bit7, Bit6,
                               Bit5, Bit4, Bit3, Bit2, Bit1, Bit0, Chars...> : bin_literal<bytes<Bytes...,
            ...
            struct hex_literal<bytes<Bytes...>, Hi, Lo, Chars...> : hex_literal<
                                                                            bytes<Bytes...,
                                                                                  static_cast<unsigned char>(
