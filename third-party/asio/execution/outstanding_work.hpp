...
namespace asio {
            ...
            struct outstanding_work_t {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        traits::static_query<T, untracked_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !query_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, untracked_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, tracked_t>::is_valid> * = 0) noexcept {
                ...
                friend constexpr outstanding_work_t query(
                        ...
                        enable_if_t<
                                can_query<const Executor &, untracked_t>::value> * = 0)
                ...
                friend constexpr outstanding_work_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, untracked_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, tracked_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                        noexcept(is_nothrow_query<const Executor &,
                ...
                struct untracked_t {
                    ...
                    static constexpr untracked_t static_query(
                            ...
                            enable_if_t<
                                    !query_member<T>::is_valid> * = 0,
                            enable_if_t<
                                    !traits::query_free<T, untracked_t>::is_valid> * = 0,
                            enable_if_t<
                                    !can_query<T, tracked_t<I>>::value> * = 0) noexcept {
                        return untracked_t();
                    }
    ...
    namespace traits {
        ...
        struct query_free_default<T, execution::outstanding_work_t,
                                  enable_if_t<
                                          !can_query<T, execution::outstanding_work_t::untracked_t>::value && can_query<T, execution::outstanding_work_t::tracked_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
