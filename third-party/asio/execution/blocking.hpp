...
namespace asio {
        ...
        namespace detail {
            ...
            struct blocking_t {
                ...
                static constexpr
                        ...
                        static_query(
                                enable_if_t<
                                        !query_static_constexpr_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        !query_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, possibly_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !query_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, possibly_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, always_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !traits::static_query<T, possibly_t>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, always_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, never_t>::is_valid> * = 0) noexcept {
                ...
                friend constexpr blocking_t query(
                        ...
                        enable_if_t<
                                can_query<const Executor &, possibly_t>::value> * = 0)
                ...
                friend constexpr blocking_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, possibly_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, always_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                ...
                friend constexpr blocking_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, always_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, never_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                ...
                struct possibly_t {
                    ...
                    static constexpr possibly_t static_query(
                            ...
                            enable_if_t<
                                    !query_member<T>::is_valid> * = 0,
                            enable_if_t<
                                    !traits::query_free<T, possibly_t>::is_valid> * = 0,
                            enable_if_t<
                                    !can_query<T, always_t<I>>::value> * = 0,
                            enable_if_t<
                                    !can_query<T, never_t<I>>::value> * = 0) noexcept {
                        return possibly_t();
                    }
                    ...
                    friend adapter<Executor> require(
                            ...
                            enable_if_t<
                                    traits::static_require<
                                            const Executor &,
                                            blocking_adaptation::allowed_t<0>>::is_valid> * = 0) {
    ...
    namespace traits {
        ...
        struct query_free_default<T, execution::blocking_t,
                                  enable_if_t<
                                          !can_query<T, execution::blocking_t::possibly_t>::value && can_query<T, execution::blocking_t::always_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
        ...
        struct query_free_default<T, execution::blocking_t,
                                  enable_if_t<
                                          !can_query<T, execution::blocking_t::possibly_t>::value && !can_query<T, execution::blocking_t::always_t>::value && can_query<T, execution::blocking_t::never_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
        ...
        struct static_query<T, execution::blocking_t,
                            enable_if_t<
                                    ...
                                    !execution::detail::blocking_t<0>::
                                            query_member<T>::is_valid &&
                                    !traits::static_query<T, execution::blocking_t::possibly_t>::is_valid && traits::static_query<T, execution::blocking_t::always_t>::is_valid>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
        ...
        struct static_query<T, execution::blocking_t,
                            enable_if_t<
                                    ...
                                    !execution::detail::blocking_t<0>::
                                            query_member<T>::is_valid &&
                                    !traits::static_query<T, execution::blocking_t::possibly_t>::is_valid && !traits::static_query<T, execution::blocking_t::always_t>::is_valid && traits::static_query<T, execution::blocking_t::never_t>::is_valid>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
        ...
        struct static_query<T, execution::blocking_t::possibly_t,
                            enable_if_t<
                                    ...
                                    !execution::detail::blocking::possibly_t<0>::
                                            query_member<T>::is_valid &&
                                    !traits::query_free<T, execution::blocking_t::possibly_t>::is_valid && !can_query<T, execution::blocking_t::always_t>::value && !can_query<T, execution::blocking_t::never_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
        ...
        struct require_free_default<T, execution::blocking_t::always_t,
                                    enable_if_t<
                                            is_same<T, decay_t<T>>::value && execution::is_executor<T>::value && traits::static_require<const T &, execution::detail::blocking_adaptation::allowed_t<0>>::is_valid>> {
            static constexpr bool is_valid = true;
