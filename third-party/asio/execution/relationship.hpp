...
namespace asio {
            ...
            struct relationship_t {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        traits::static_query<T, fork_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !query_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, fork_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, continuation_t>::is_valid> * = 0) noexcept {
                ...
                friend constexpr relationship_t query(
                        ...
                        enable_if_t<
                                can_query<const Executor &, fork_t>::value> * = 0)
                ...
                friend constexpr relationship_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, fork_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, continuation_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                ...
                struct fork_t {
                    ...
                    static constexpr fork_t static_query(
                            ...
                            enable_if_t<
                                    !query_member<T>::is_valid> * = 0,
                            enable_if_t<
                                    !traits::query_free<T, fork_t>::is_valid> * = 0,
                            enable_if_t<
                                    !can_query<T, continuation_t<I>>::value> * = 0) noexcept {
                        return fork_t();
                    }
    ...
    namespace traits {
        ...
        struct query_free_default<T, execution::relationship_t,
                                  enable_if_t<
                                          !can_query<T, execution::relationship_t::fork_t>::value && can_query<T, execution::relationship_t::continuation_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
