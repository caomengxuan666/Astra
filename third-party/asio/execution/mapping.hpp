...
namespace asio {
            ...
            struct mapping_t {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        traits::static_query<T, thread_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !query_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, thread_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, new_thread_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !traits::static_query<T, thread_t>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, new_thread_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, other_t>::is_valid> * = 0) noexcept {
                ...
                friend constexpr mapping_t query(
                        ...
                        enable_if_t<
                                can_query<const Executor &, thread_t>::value> * = 0)
                ...
                friend constexpr mapping_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, thread_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, new_thread_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                        noexcept(
                ...
                friend constexpr mapping_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, new_thread_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, other_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                ...
                struct thread_t {
                    ...
                    static constexpr thread_t static_query(
                            ...
                            enable_if_t<
                                    !query_member<T>::is_valid> * = 0,
                            enable_if_t<
                                    !traits::query_free<T, thread_t>::is_valid> * = 0,
                            enable_if_t<
                                    !can_query<T, new_thread_t<I>>::value> * = 0,
                            enable_if_t<
                                    !can_query<T, other_t<I>>::value> * = 0) noexcept {
                        return thread_t();
                    }
    ...
    namespace traits {
        ...
        struct query_free_default<T, execution::mapping_t,
                                  enable_if_t<
                                          !can_query<T, execution::mapping_t::thread_t>::value && can_query<T, execution::mapping_t::new_thread_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
        ...
        struct query_free_default<T, execution::mapping_t,
                                  enable_if_t<
                                          !can_query<T, execution::mapping_t::thread_t>::value && !can_query<T, execution::mapping_t::new_thread_t>::value && can_query<T, execution::mapping_t::other_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
        ...
        struct static_query<T, execution::mapping_t,
                            enable_if_t<
                                    ...
                                    !execution::detail::mapping_t<0>::
                                            query_member<T>::is_valid &&
                                    !traits::static_query<T, execution::mapping_t::thread_t>::is_valid && traits::static_query<T, execution::mapping_t::new_thread_t>::is_valid>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
        ...
        struct static_query<T, execution::mapping_t,
                            enable_if_t<
                                    ...
                                    !execution::detail::mapping_t<0>::
                                            query_member<T>::is_valid &&
                                    !traits::static_query<T, execution::mapping_t::thread_t>::is_valid && !traits::static_query<T, execution::mapping_t::new_thread_t>::is_valid && traits::static_query<T, execution::mapping_t::other_t>::is_valid>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
        ...
        struct static_query<T, execution::mapping_t::thread_t,
                            enable_if_t<
                                    ...
                                    !execution::detail::mapping::thread_t<0>::
                                            query_member<T>::is_valid &&
                                    !traits::query_free<T, execution::mapping_t::thread_t>::is_valid && !can_query<T, execution::mapping_t::new_thread_t>::value && !can_query<T, execution::mapping_t::other_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
