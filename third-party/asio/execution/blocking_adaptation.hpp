...
namespace asio {
            ...
            struct blocking_adaptation_t {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        traits::static_query<T, disallowed_t>::is_valid> * = 0) noexcept {
                ...
                static constexpr
                        ...
                        static_query(
                                ...
                                enable_if_t<
                                        !query_member<T>::is_valid> * = 0,
                                enable_if_t<
                                        !traits::static_query<T, disallowed_t>::is_valid> * = 0,
                                enable_if_t<
                                        traits::static_query<T, allowed_t>::is_valid> * = 0) noexcept {
                ...
                friend constexpr blocking_adaptation_t query(
                        ...
                        enable_if_t<
                                can_query<const Executor &, disallowed_t>::value> * = 0)
                ...
                friend constexpr blocking_adaptation_t query(
                        ...
                        enable_if_t<
                                !can_query<const Executor &, disallowed_t>::value> * = 0,
                        enable_if_t<
                                can_query<const Executor &, allowed_t>::value> * = 0)
#if !defined(__clang__)// Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC) // Visual C++ wants the type to be qualified.
                        noexcept(is_nothrow_query<const Executor &,
                ...
                struct disallowed_t {
                    ...
                    static constexpr disallowed_t static_query(
                            ...
                            enable_if_t<
                                    !query_member<T>::is_valid> * = 0,
                            enable_if_t<
                                    !traits::query_free<T, disallowed_t>::is_valid> * = 0,
                            enable_if_t<
                                    !can_query<T, allowed_t<I>>::value> * = 0) noexcept {
                        return disallowed_t();
                    }
    ...
    namespace traits {
        ...
        struct query_free_default<T, execution::blocking_adaptation_t,
                                  enable_if_t<
                                          !can_query<T, execution::blocking_adaptation_t::disallowed_t>::value && can_query<T, execution::blocking_adaptation_t::allowed_t>::value>> {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept =
